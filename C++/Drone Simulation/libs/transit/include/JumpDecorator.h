...
class JumpDecorator : public CelebrationDecorator {
 public:
  /**
  * @brief Constructor for the JumpDecorator class; calls the
  ...
  */
  ...
  /**
  * @brief Checks if the jumping motion is completed by comparing the current
  ...
  */
  bool IsCompleted();
  /**
  * @brief Moves the entity using the strategy from the constructor and jumps
  * when the movement is complete.
  * @param entity An IEntity* object of the entity to move and do the jump
  * animation on.
