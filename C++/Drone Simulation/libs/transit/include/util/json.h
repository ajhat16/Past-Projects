...
#include "WebServer.h"
#include "picojson.h"
#include "../../../util/include/xutil.h"

/**
 * @brief If defined, use original picojson type casting
 * @author Read S
 */
#undef USE_ORIG_PICOJSON_CASTING

//#define USE_ORIG_PICOJSON_CASTING

#ifdef USE_ORIG_PICOJSON_CASTING
#warning "Using picojson"
#endif
...
#else
		return str_cast<double>(ToString());
#endif
	}
...
inline JsonValue& JsonValue::operator=(JsonValue&& other)
